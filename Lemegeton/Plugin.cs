...
namespace Lemegeton
{
    ...
    public sealed class Plugin : IDalamudPlugin
    {
        ...
        internal List<Tuple<Version, string>> ChangeLog = new List<Tuple<Version, string>>()
        {
            ...
            new Tuple<Version, string>(new System.Version("1.0.6.3"), "Changelog/1.0.6.3"),
            ...
            new Tuple<Version, string>(new System.Version("1.0.7.6"), "Changelog/1.0.7.6"),
            ...
            new Tuple<Version, string>(new System.Version("1.0.8.3"), "Changelog/1.0.8.3"),
